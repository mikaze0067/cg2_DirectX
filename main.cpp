...
Transform cameratransform{ {1.0f,1.0f,1.0f},{0.3f,0.0f,0.0f},{0.0f,4.0f,-15.0f} };
...
#pragma region Textureを読んで転送(2つ目)
	...
	ID3D12Resource* intermeditateResource2 = UploadTextureData(textureResource2, mipImages2, device, commandList);
#pragma endregion
...
#pragma endregion
	...
	while (msg.message != WM_QUIT) {
		...
		if (PeekMessage(&msg, NULL, 0, 0, PM_REMOVE)) {
			...
			//マテリアルCBufferの場所を設定
			//commandList->SetGraphicsRootConstantBufferView(0, materialResource->GetGPUVirtualAddress());変更
